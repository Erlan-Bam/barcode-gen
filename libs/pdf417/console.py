...
parser = ArgumentParser(
    epilog="https://github.com/mosquito/pdf417",
...
subparser.add_argument(
    "-c", "--columns", type=int, default=6, help="The number of columns (default is 6)."
)

subparser.add_argument(
    "-l", "--security-level", default=2, type=int, help="Security level (default is 2)."
)
...
subparser.add_argument(
    ...
    "--numeric_compaction",
    action="store_true",
    help="This mode can pack almost 3 digits " "(2.93) info a symbol character",
)

subparser.add_argument(
    "-s", "--scale", default=3, type=int, help="Module width in pixels (default is 3)."
)
...
def entrypoint():
    logging.basicConfig(format="\033[91m%(message)s\033[0m", level=logging.INFO)
